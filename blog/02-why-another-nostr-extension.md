...
**Chat:** NIP-17 encrypted DMs with gift wraps. NIP-04 + NIP-44 fallback. Private groups (NIP-17 to each member). Relay communities (NIP-29). Open channels (NIP-28). Reply, react, forward, delete. Content warnings. Expiring messages.
