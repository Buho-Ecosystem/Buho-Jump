...
**WXT** (Web Extension Toolkit) for the build system. Handles manifest generation, hot reload, multi-browser builds (Chrome MV3, Firefox MV3, Edge), and entrypoint routing. One config file, four browser targets.
