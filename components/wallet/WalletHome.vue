...
<template>
  <div class="space-y-4 animate-fade-in-up">
    ...
    <!-- Balance card -->
    <div class="relative overflow-hidden bg-surface-card rounded-2xl border border-border p-5">
      ...
      <div class="relative">
        ...
        <div class="grid grid-cols-2 gap-3">
          <button
            @click="emit('send')"
            class="flex flex-col items-center justify-center gap-1 py-4 rounded-2xl text-white text-sm font-semibold transition-colors active:scale-[0.98] btn-action-send"
          >
          ...
          <button
            @click="emit('receive')"
            class="flex flex-col items-center justify-center gap-1 py-4 rounded-2xl text-white text-sm font-semibold transition-colors active:scale-[0.98] btn-action-receive"
          >
    ...
    <div class="space-y-2">
      <div class="flex items-center justify-between px-1">
        ...
        <button
          ...
          @click="emit('history')"
          class="flex items-center gap-0.5 text-[10px] text-text-muted hover:text-brand transition-colors font-medium"
        >
      ...
      <div v-if="loadingTxs" class="space-y-2">
        <div v-for="i in 3" :key="i" class="skeleton-shimmer h-12 rounded-xl" />
      </div>
