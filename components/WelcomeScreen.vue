<script setup>
/**
 * A single introduction before password setup.
    ...
    <!-- ═══ STEP 1: Meet Buho ═══ -->
      <div class="flex-1 flex flex-col items-center">
        ...
        <div class="flex flex-col items-center mb-4 animate-fade-in">
          ...
          <span class="text-xs font-semibold text-text-muted tracking-widest uppercase">Buho Jump</span>
        </div>
      ...
      <div class="w-full max-w-[300px] mt-6 space-y-3">
        ...
        <div v-if="showLangPicker" class="bg-surface-card rounded-2xl border border-border p-2 grid grid-cols-2 gap-0.5 animate-fade-in-up">
          <button
            ...
            class="flex items-center gap-2 px-3 py-2 rounded-xl text-xs transition-colors text-left"
